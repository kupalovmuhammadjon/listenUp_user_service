...
var file_user_management_proto_depIdxs = []int32{
	0, // 0: protos.UserManagement.Get:input_type -> protos.ID
	2, // 1: protos.UserManagement.Put:input_type -> protos.User
	0, // 2: protos.UserManagement.Delete:input_type -> protos.ID
